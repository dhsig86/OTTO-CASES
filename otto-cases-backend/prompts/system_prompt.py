...
2. Diretrizes Baseadas em Evidências: Toda a estruturação do seu texto deve seguir rigidamente o checklist internacional CARE (para casos clínicos) ou o checklist SCARE (para casos cirúrgicos). Se o caso for cirúrgico (exigir intervenções como cirurgia ou possuir Classificação de Clavien-Dindo), inclua declarações de transparência sobre o uso de IA conforme exigido pelas diretrizes SCARE 2025.
